...
let sum2 = (a, b, c, d) => a + b + c + d; // refactored by arrow function
...
let objectLit2 = () => ({ key1: 'value1', key2: 'value2', key3: 'value3', }); // refactored by arrow function
...
let sumAndProduct2 = (a, b) => { // refactored by arrow function
  let sum = a + b;
  let product = a * b;
  return [sum, product];
}
...
let message2 = name => `Hello, ${name}!`; // refactored by arrow function
...
// let Students = (name, age, hometown) => {  refactored as arrow function but gives Uncaught TypeError: Students is not a constructor
//   this.name = name;
//   this.age = age;
//   this.hometown = hometown;
// };

// let joy = new Students('Joy', 'Schmoe', 100);
// console.log(joy);
...
// Student.prototype.greeting = () => `Hi, my name is ${this.name}`; // refactored as arrow function
// console.log(joe.greeting()); // it is shows "Hi, My name is" but breaks after "this."
...
Student.courseName = () => `This student is enrolled in Code 301.`; // refactored as arrow function
console.log(Student.courseName());
...
// TODO: Uncomment the following line of code to see the output in the browser console
console.log(joe.scope()); // it gives undefined

Student.prototype.scopeArrow = () => console.log(this); // it gives window object

// TODO: Uncomment the following line of code to see the output in the browser console
console.log(joe.scopeArrow()); // it gives undefined 
